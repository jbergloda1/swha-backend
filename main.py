...
from app.api.routes import auth, users, videos, upload, qa, tts, lipsync, stt, captioning, dashboard, table
...
app.include_router(table.router, prefix="/api/v1/table", tags=["table"])
